...
bool update(float delta_time) {
	...
	{
		target_mesh.get_transform().translate(vec3(0.0f, 0.0f, -1.0f));
		cam.translate(vec3(0.0f, 0.0f, -1.0f));
	}
	...
	{
		target_mesh.get_transform().translate(vec3(-1.0f, 0.0f, 0.0f));
		cam.translate(vec3(-1.0f, 0.0f, 0.0f));
	}
